...
import com.squidster.furnituretester.R
...
// This is the adapter used by the recycler for our 3D models class
class ModelAdpater(
    val models: List<Model>
) : RecyclerView.Adapter<ModelAdpater.ModelViewHolder>() {
